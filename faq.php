	...
	<!-- End of menu navigation bar -->
       ...
       <!-- Start of FAQ -->
        <div class="questionsContainer">
                ...
                <p class="questionsStyling questionsFontStyle">Q: How do i place an oder?<br>
                    <br>
                    A:Login in to your account and use the checkout form to pay your shopping cart.
                </p>
                <p class="questionsStyling questionsFontStyle">Q: How do I return an itemn?<br>
                    <br>
                    A: There is a reutrn form in your login account>
                </p>
